...
Plug 'mhinz/vim-sayonara', { 'on': 'Sayonara' } " Intuitive buffer closing.
Plug 'talek/obvious-resize', { 'on': ['ObviousResizeUp', 'ObviousResizeDown', 'ObviousResizeLeft', 'ObviousResizeRight'] } " Intuitive split resizing.
